...
_t 'Copyright (C) 2020 mirage335
See the end of the file for license conditions.
See license.txt for metaBus license conditions.


Reference implementation - &#39;metaBus&#39; intended to provide minimalist source-code examples to include in other projects.'
_t '
...
_heading1 'Design'
_paragraph_begin [
_t 'Please keep all examples and associated code as &#39;elegant&#39; as possible - perhaps simple and nonrepetitive - to best illustrate logic flow. Flow charts may not be adequate to supplement unnecessarily complicated code.
...
_t 'Any serialization format should be acceptable for sending messages across shared channels. However, these channels should be assumed &#39;noisy&#39; so that multiple serialization formats may be used simulaneously.'
_heading2 'Transports'
_t 'Existing IPC transports may be used with, or independently of, MetaEngine . However, the essential benefits of ad-hoc real-time redirection, innumerable &#39;ports&#39;, noise/collision tolerance, native executable multiplatform compatibility (UNIX/MSW), may not be directly provided.'
_heading3 'ZeroMQ'
_t 'May not offer an MSW compatible transport layer.
...
_heading3 'RabbitMQ'
_t 'https://www.rabbitmq.com/tutorials/tutorial-three-python.html'
_heading3 'DBus'
_t '"If you use this low-level API directly, you&#39;re signing up for some pain."
...
_heading3 'FIFO'
_t 'As typically provided by OS, FIFO (named pipe) may not be directly receivable by multiple recipients.

https://stackoverflow.com/questions/33613341/how-to-send-broadcast-messages-with-named-pipe-using-c'
_heading3 'TCP'
_t 'A possible workaround may be to declare a &#39;standard&#39; TCP port for IPC by the &#39;primary&#39; user of a computer, an approach typical of &#39;extendedInterface&#39;.'
_paragraph_end ]
_t '
...
_paragraph_begin
_t 'Best practice may be to add a &#39;git submodule&#39; to a &#39;_lib&#39; subdirectory of any project using &#39;metaBus&#39; .
...
_paragraph_begin
_t 'Entire &#39;recursive&#39; clones of the &#39;metaBus&#39; and derivative repositories may be appropriate for redistribution and preservation.
...
_paragraph_begin
_t '* Demonstrate ability to preserve less dependable SSDs (ie. typical SD Cards) by automatically detecting usable &#39;/dev/shm&#39; as "$metaDir" (derived from "$metaTmp") location (also applies to upstream Ubiquitous Bash).
